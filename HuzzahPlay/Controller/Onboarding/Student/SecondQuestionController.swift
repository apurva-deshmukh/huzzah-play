//
//  SecondQuestionController.swift
//  HuzzahPlay
//
...
class SecondQuestionController: UIViewController {
    ...
    @objc func didTapNext() {
        ...
        let controller = ThirdQuestionController(student: student)
...
extension SecondQuestionController: UITableViewDataSource {
...
extension SecondQuestionController: UITableViewDelegate {
